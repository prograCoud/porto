					...
					'desc'  => wp_kses( 
						...
						<span class="flex-row">
							...
							<span>
								...
								An archive template allows you to easily design the layout and style of archive pages - those pages that show a list of posts (e.g. a blog’s list of recent posts), which may be filtered by terms such as authors, categories, tags, search results, etc.
							</span>
						</span>													
						</span>', 'porto' ), 
						array( 
		...
		'fields'     => array(
			array(
				...
				'desc'  => wp_kses(
					...
					sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Post Archive(Blog)</a> & <a href="%2$s" target="_blank">Post Type(Loop)</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $archive_url, $type_url ),
					array(
						'strong' => array(),
						'b'      => array(),
						'a'      => array(
	...
	$this->sections[] = array(
		...
		'fields'     => array(
			array(
				...
				'desc'  => wp_kses(
					/* translators: %s: Builder url */
					sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Single Post</a> & <a href="%2$s" target="_blank">Post Type(Loop)</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $single_url, $type_url ),
					array(
						'strong' => array(),
						'b'      => array(),
						'a'      => array(
	...
	$this->sections[] = array(
		...
		'fields'     => array(
			array(
				...
				'desc'  => wp_kses(
					/* translators: %s: Builder url */
					sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Single Post</a> & <a href="%2$s" target="_blank">Post Type(Loop)</a> Builders help you to develop your site easily.', 'porto' ), $single_url, $type_url ),
					array(
						'strong' => array(),
						'a'      => array(
							'href'   => array(),
	...
	$this->sections[] = array(
		...
		'fields'     => array(
			array(
				...
				'desc'  => wp_kses(
					/* translators: %s: Builder url */
					sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Portfolio Archive</a> & <a href="%2$s" target="_blank">Portfolio Type</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $archive_url, $type_url ),
					array(
						'strong' => array(),
						'b'      => array(),
						'a'      => array(
	...
	$this->sections[] = array(
		...
		'fields'     => array(
			array(
				...
				'desc'  => wp_kses(
					/* translators: %s: Builder url */
					sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Single Portfolio</a> & <a href="%2$s" target="_blank">Portfolio Type</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $single_url, $type_url ),
					array(
						'strong' => array(),
						'b'      => array(),
						'a'      => array(
		...
		array(
			...
			'fields'     => array(
				array(
					...
					'desc'  => wp_kses(
						/* translators: %s: Builder url */
						sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Event Archive</a> & <a href="%2$s" target="_blank">Event Type</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $archive_url, $type_url ),
						array(
							'strong' => array(),
							'b'      => array(),
							'a'      => array(
		...
		array(
			...
			'fields'     => array(
				array(
					...
					'desc'  => wp_kses(
						/* translators: %s: Builder url */
						sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Member Archive</a> & <a href="%2$s" target="_blank">Member Type</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $archive_url, $type_url ),
						array(
							'strong' => array(),
							'b'      => array(),
							'a'      => array(
		...
		array(
			...
			'fields'     => array(
				array(
					...
					'desc'  => wp_kses(
						/* translators: %s: Builder url */
						sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Single Member</a> & <a href="%2$s" target="_blank">Member Type</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $single_url, $type_url ),
						array(
							'strong' => array(),
							'b'      => array(),
							'a'      => array(
