		...
		'fields'     => array(
			array(
				...
				'desc'  => wp_kses(
					...
					sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Product Archive</a> & <a href="%2$s" target="_blank">Product Type</a> Builders help you to develop shop page easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $shop_url, $type_url ),
					array(
						'strong' => array(),
						'b'      => array(),
						'a'      => array(
			...
			array(
				...
				'desc'     => wp_kses(
					__( '<span style="color: red">Sidebar with Toggle</span> and <span style="color: red">Off Canvas</span> filter require the page layout which has sidebar.<br/><span style="color: red">Horizontal filter</span> is shown with <a target="_blank" href="' . esc_url( admin_url( 'widgets.php' ) ) . '">Shop Horizontal Widget</a> in Appearance > Widgets.<br/>If you use Shop Builder, filter sidebar should be shown with <span style="color: red">Filter Toggle</span> widget.', 'porto' ),
					array(
						'span' => array(
							'style' => array(),
						),
	...
	$this->sections[] = array(
		...
		'fields'     => array(
			array(
				...
				'desc'  => wp_kses(
					/* translators: %s: Builder url */
					sprintf( __( '<strong>Important Note:</strong> <a href="%1$s" target="_blank">Single Product</a> & <a href="%2$s" target="_blank">Product Type</a> Builders help you to develop your site easily. Some below options might be overrided because the priority of the builder widget option is <b>higher</b>.', 'porto' ), $product_url, $type_url ),
					array(
						'strong' => array(),
						'b'      => array(),
						'a'      => array(
