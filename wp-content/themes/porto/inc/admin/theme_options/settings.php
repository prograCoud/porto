...
if ( ! class_exists( 'Redux_Framework_porto_settings' ) ) {
	class Redux_Framework_porto_settings {
		...
		public function setSections() {
			...
			$archive_url = $single_url = $type_url = $header_url = $footer_url = $shop_url = $product_url = $popup_url = admin_url( 'admin.php?page=porto-speed-optimize-wizard&step=general' );
							...
							<span>
								<span class="flex-row">
									...
									<span>
										...
										Popup like Newsletter, promo, discount is built with pre-made on template builder.
									</span>
								</span>										
							</span>', 'porto' ), 
							array( 
			...
			$skin_search_form = array(
				...
				array(
					...
					'required' => array( 'search-layout', 'equals', array( 'large', 'advanced' ) ),
				),
				array(
					...
					'fields'     => array_merge(
						array(
							...
							array(
								...
								'type'     => 'switch',
								'title'    => __( 'Border Radius', 'porto' ),
								'required' => array( 'search-layout', 'equals', array( 'simple', 'large', 'advanced' ) ),
								'default'  => true,
								'hint'     => array(
