	...
	if ( function_exists( 'vc_map' ) ) {
		...
		vc_add_param(
			...
			array(
				...
				'text'       => esc_html__( 'Section', 'porto-functionality' ),
				'group'      => $section_group,
			)
		);	
		vc_add_param(
		...
		vc_add_param(
			...
			array(
				...
				'text'       => esc_html__( 'Divider', 'porto-functionality' ),
				'group'      => $section_group,
				'dependency' => array(
					'element'   => 'is_section',
					'not_empty' => true,
		...
		vc_add_params(
			...
			array(
				array(
					...
					'description' => sprintf( esc_html__( 'Section\'s width changes when scrolling page. For more infomation, read this %1$sarticle%2$s.', 'porto' ), '<a href="https://www.portotheme.com/wordpress/porto/documentation/how-to-add-scroll-paralax-effect/" target="_blank">', '</a>' ),
		...
		vc_add_params(
			...
			array(
				array(
					...
					'value'       => array( __( 'Yes, please', 'js_composer' ) => 'yes' ),
					'description' => sprintf( esc_html__( 'For Hover Split, the row should have two split slide columns. For more infomation, read this %1$sarticle%2$s.', 'porto' ), '<a href="https://www.portotheme.com/wordpress/porto/documentation/how-to-use-hover-split-effect/" target="_blank">', '</a>' ),
					'group'       => $addon_group,
				),
				array(
					'type'        => 'textfield',
		...
		vc_add_params(
			...
			array(
				...
				array(
					...
					'description' => sprintf( esc_html__( 'Section\'s background color changes when scrolling page. For more infomation, read this %1$sarticle%2$s.', 'porto' ), '<a href="https://www.portotheme.com/wordpress/porto/documentation/how-to-use-scroll-in-viewport/" target="_blank">', '</a>' ),
					'group'       => $addon_group,
				),
				array(
					'type'        => 'checkbox',
		...
		vc_add_param(
			...
			array(
				...
				'text'       => esc_html__( 'Half Container', 'porto-functionality' ),
				'group'      => $section_group,
			)
		);
		vc_add_param(
		...
		vc_add_params(
			...
			array(
				array(
					...
					'value'       => array( __( 'Yes, please', 'js_composer' ) => 'yes' ),
					'description' => sprintf( esc_html__( 'The Hover Split option of the parent row should be selected. For more infomation, read this %1$sarticle%2$s.', 'porto' ), '<a href="https://www.portotheme.com/wordpress/porto/documentation/how-to-use-hover-split-effect/" target="_blank">', '</a>' ),
					'group'       => $addon_group,
				),
				array(
					'type'       => 'porto_param_heading',
