...
class Porto_Elementor_Single_Comments_Widget extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'heading_image_style',
			array(
				'label' => esc_html__( 'Comments Avatar Image', 'porto-functionality' ),
		...
		$this->add_control(
			...
			array(
				'type'        => Controls_Manager::SLIDER,
				'label'       => __( 'Avatar Image Spacing (px)', 'porto-functionality' ),
				'size_units'  => array(
					'px',
					'rem',
					'em',
		...
		$this->add_control(
			...
			array(
				'type'        => Controls_Manager::SLIDER,
				'label'       => __( 'Max Width of Comment Avatar Image', 'porto-functionality' ),
				'size_units'  => array(
					'px',
					'rem',
					'em',
		...
		$this->add_control(
			...
			array(
				'type'        => Controls_Manager::SLIDER,
				'label'       => __( 'Border Radius of Comment Avatar Image', 'porto-functionality' ),
				'size_units'  => array(
					'px',
					'rem',
					'%',
