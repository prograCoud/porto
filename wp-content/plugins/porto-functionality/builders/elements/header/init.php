	...
	class PortoBuildersHeader {
		...
		public function load_wpb_map_elements() {
				...
				array(
					...
					'params'      => array(
						array(
							...
							'text'       => esc_html__( 'Please change the settings of logo in \'Theme Options -> Logo\' panel.', 'porto-functionality' ),
						),
						$custom_class,
					),
				)
			...
			vc_map(
				array(
					...
					'params'      => array(
						...
						array(
							'type'       => 'textfield',
							'heading'    => __( 'Left / Right Padding (e.g: 10px)', 'porto-functionality' ),
							'param_name' => 'padding',
							'dependency' => array(
								'element' => 'location',
								'value'   => array( 'main-toggle-menu', 'nav-top' ),
						...
						array(
							'type'       => 'textfield',
							'heading'    => __( 'Popup Width (px)', 'porto-functionality' ),
						...
						array(
							...
							'group'      => __( 'Top Level Menu', 'porto-functionality' ),
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'mainmenu-toplevel-link-color' ) . '" target="_blank">', '</a>' ),
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'mainmenu-toplevel-hbg-color' ) . '" target="_blank">', '</a>' ),
							'group'      => __( 'Top Level Menu', 'porto-functionality' ),
						),
						array(
							'type'        => 'porto_number',
						...
						array(
							...
							'selectors'  => array(
								...
								'#header {{WRAPPER}}.mega-menu > li.has-sub:before, #header {{WRAPPER}}.mega-menu > li.has-sub:after' => 'border-bottom-color: {{VALUE}};',
								'{{WRAPPER}} .sidebar-menu .popup:before' => 'border-right-color: {{VALUE}};'
							),
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'mainmenu-popup-bg-color' ) . '" target="_blank">', '</a>' ),
							'group'      => __( 'Menu Popup', 'porto-functionality' ),
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'mainmenu-popup-heading-color' ) . '" target="_blank">', '</a>' ),
			...
			$border_radius_selectors = array(
				...
				'#header {{WRAPPER}} .searchform.search-layout-reveal input'  => 'border-radius: {{VALUE}};',
				...
				array(
					...
					'params'      => array(
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'search-placeholder' ) . '" target="_blank">', '</a>' ),
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option. To show %3$scategory filter%4$s, you must select one of the %5$sSearch Content Type%2$s.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'search-cats' ) . '" target="_blank">', '</a>', '<b>', '</b>', '<a href="' . porto_get_theme_option_url( 'search-type' ) . '" target="_blank">' ),
							'std'         => '',
							'admin_label' => true,
						),
						array(
							...
							'description' => sprintf( __( 'Show categories including subcategory. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'search-sub-cats' ) . '" target="_blank">', '</a>' ),
							'param_name'  => 'sub_cats',
							'dependency'  => array(
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'search-cats-mobile' ) . '" target="_blank">', '</a>' ),
							'std'         => '',
							'admin_label' => true,
							'dependency'  => array(
								'element' => 'category_filter',
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'sticky-searchform-toggle-color' ) . '" target="_blank">', '</a>' ),
							'group'      => __( 'Toggle Icon Style', 'porto-functionality' ),
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'description' => sprintf( __( 'Controls the background color of search form. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'searchform-bg-color' ) . '" target="_blank">', '</a>' ),
							'selectors'   => array(
						...
						array(
							...
							'description' => __( 'Controls the border width of search form. Input units together. e.g: 1px', 'porto-functionality' ),
						...
						array(
							...
							'description' => sprintf( __( 'Controls the border color of search form. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'searchform-border-color' ) . '" target="_blank">', '</a>' ),
							'param_name'  => 'border_color',
							'value'       => '',
							'selectors'   => array(
								'#header {{WRAPPER}} .searchform' => 'border-color: {{VALUE}};',
								'#header {{WRAPPER}} .searchform .searchform.search-layout-overlay .selectric-cat' => 'border-color: {{VALUE}};',
								'#header {{WRAPPER}} .searchform.search-layout-overlay .text' => 'border-color: {{VALUE}};',
								'#header {{WRAPPER}} .searchform .searchform.search-layout-overlay .button-wrap' => 'border-color: {{VALUE}};',
						...
						array(
							...
							'description' => sprintf( __( 'Controls placeholder color of the input box. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'searchform-text-color' ) . '" target="_blank">', '</a>' ),
							'selectors'   => array(
						...
						array(
							...
							'description' => __( 'Controls the width of input box in form. Input units together. e.g: 200px', 'porto-functionality' ),
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'searchform-hover-color' ) . '" target="_blank">', '</a>' ),
							'group'      => __( 'Search Form Style', 'porto-functionality' ),
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'searchform-border-color' ) . '" target="_blank">', '</a>' ),
							'group'      => __( 'Search Form Style', 'porto-functionality' ),
						),
						array(
							'type'       => 'porto_param_heading',
						...
						array(
							...
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'searchform-text-color' ) . '" target="_blank">', '</a>' ),
							'dependency' => array(
								'element' => 'category_filter',
								'value'   => 'yes',
							),
				...
				array(
					...
					'params'      => array(
						...
						array(
							...
							'param_name' => 'icon_cl',
							'description' => sprintf( __( 'You can see icons %1$shere%2$s.', 'porto-functionality' ), '<a href="https://www.portotheme.com/wordpress/porto/shortcodes/icons/" target="_blank">', '</a>' ),
						),
						array(
							'type'       => 'textfield',
							'heading'    => __( 'Icon Size', 'porto-functionality' ),
						...
						array(
							...
							'param_name' => 'bg_color',
							'value'      => '',
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'mobile-menu-toggle-bg-color' ) . '" target="_blank">', '</a>' ),
						),
						array(
							'type'       => 'colorpicker',
							...
							'param_name' => 'color',
							'value'      => '',
							'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'mobile-menu-toggle-text-color' ) . '" target="_blank">', '</a>' ),
						),
						array(
							'type'        => 'porto_dimension',
							'heading'     => __( 'Padding', 'porto-functionality' ),
					...
					array(
						...
						'params'      => array(
							array(
								...
								'heading'     => __( 'Type', 'porto-functionality' ),
								'description' => sprintf( __( 'Controls the cart type. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-type' ) . '" target="_blank">', '</a>' ),
								'param_name'  => 'type',
								'value'       => array(
									'cart/cart-none.svg'      => 'none',
							...
							array(
								...
								'std'         => '',
								'admin_label' => true,
								'description' => sprintf( __( 'Controls the content type: dropdown or offcanvas. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-content' ) . '" target="_blank">', '</a>' ),
							),
							array(
								'type'        => 'textfield',
								'heading'     => __( 'Custom Icon Class', 'porto-functionality' ),
								'param_name'  => 'icon_cl',
								'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.%3$sYou can see icons %4$shere%2$s', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-icon' ) . '" target="_blank">', '</a>', '<br/>', '<a href="https://www.portotheme.com/wordpress/porto/shortcodes/icons/" target="_blank">' ),
								'std'         => 'porto-icon-cart-thick',
								'save_always' => true,
							),
							array(
								'type'        => 'textfield',
								...
								'std'         => '26px',
								'save_always' => true,
								'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-icon-font-size' ) . '" target="_blank">', '</a>' ),
							),
							array(
								'type'       => 'colorpicker',
								'heading'    => __( 'Icon Color', 'porto-functionality' ),
								'param_name' => 'icon_color',
								'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-icon-color' ) . '" target="_blank">', '</a>' ),
								'selectors'   => array(
							...
							array(
								...
								'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'sticky-minicart-icon-color' ) . '" target="_blank">', '</a>' ),
								'selectors'   => array(
							...
							array(
								...
								'description' => sprintf( __( 'Controls the the color of badge. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-item-color' ) . '" target="_blank">', '</a>' ),
								'selectors'   => array(
							...
							array(
								...
								'description' => sprintf( __( 'Controls the the background color of badge. You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-item-bg-color' ) . '" target="_blank">', '</a>' ),
								'selectors'   => array(
					...
					vc_map(
						array(
							...
							'params'      => array(
								...
								array(
									'type'       => 'colorpicker',
									'heading'    => __( 'Color In Sticky Header', 'porto-functionality' ),
									'param_name' => 'sticky_color',
									'selectors'   => array(
								...
								array(
									'type'       => 'colorpicker',
									'heading'    => __( 'Hover Color In Sticky Header', 'porto-functionality' ),
									'param_name' => 'sticky_hover_color',
									'selectors'   => array(
