		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'description'            => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-icon' ) . '" target="_blank">', '</a>' ),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'selectors'   => array(
						'#mini-cart .cart-head, #mini-cart.minicart-inline .cart-head' => 'font-size: {{SIZE}}{{UNIT}};',
					),
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-item-color' ) . '" target="_blank">', '</a>' ),
				)
			);
			...
			$this->add_control(
				...
				array(
					...
					'description' => sprintf( __( 'You can change %1$sglobal%2$s value in theme option.', 'porto-functionality' ), '<a href="' . porto_get_theme_option_url( 'minicart-item-bg-color' ) . '" target="_blank">', '</a>' ),
				)
			);
