...
function porto_load_modal_shortcode() {
	...
	vc_map(
		array(
			...
			'base'                    => 'porto_modal',
			'icon'                    => PORTO_WIDGET_URL . 'modal.png',
			'class'                   => 'porto-wpb-widget porto_modal',
			...
			'params'                  => array(
				...
				array(
					...
					'hint'       => '<img src="' . PORTO_HINT_URL . 'wd_modal-modal_style-zoomIn.gif"/>',
					'value'      => array(
				...
				array(
					...
					'hint'       => '<img src="' . PORTO_HINT_URL . 'wd_modal-overlay_bg_color.gif"/>',
					'value'      => '',
				),
				array(
					'type'        => 'number',
