...
function porto_load_price_boxes_shortcode() {
	...
	vc_map(
		array(
			...
			'icon'            => PORTO_WIDGET_URL . 'price-box.png',
			...
			'params'          => array(
				array(
					...
					'description' => __( 'Select the type of pricing table.', 'porto-functionality' ),
					'param_name'  => 'style',
				...
				array(
					'type'        => 'checkbox',
					'heading'     => __( 'Show Border', 'porto-functionality' ),
					'description' => __( 'Turn on to show border in price boxes.', 'porto-functionality' ),
					'param_name'  => 'border',
					'std'         => 'yes',
				...
				array(
					'type'        => 'checkbox',
					'heading'     => __( 'Enable Gap', 'porto-functionality' ),
					'description' => __( 'Turn on to enable the gap between price boxes.', 'porto-functionality' ),
					'param_name'  => 'space',
					'std'         => '',
					'value'       => array( __( 'Yes', 'js_composer' ) => 'yes' ),
				),
