		...
		array(
			...
			'params'       => array(
				...
				array(
					...
					'responsive' => true,
					'selectors'  => array(
						'{{WRAPPER}} .side-menu-accordion .popup .sub-menu, {{WRAPPER}} .side-menu-slide .popup .sub-menu, {{WRAPPER}} .sidebar-menu:not(.side-menu-slide) .wide .popup > .inner' => 'padding: {{TOP}} {{RIGHT}} {{BOTTOM}} {{LEFT}};',
