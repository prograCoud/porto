...
function porto_load_contact_form_shortcode() {
	...
	vc_map(
		array(
			...
			'icon'        => PORTO_WIDGET_URL . 'contact-form.png',
			...
			'params'      => array(
				...
				array(
					...
					'param_name'  => 'br',
					'selectors'   => array(
						'{{WRAPPER}} input, {{WRAPPER}} textarea, {{WRAPPER}} .form-control, {{WRAPPER}} select' => 'border-top-left-radius: {{TOP}};border-top-right-radius: {{RIGHT}};border-bottom-right-radius: {{BOTTOM}};border-bottom-left-radius: {{LEFT}};',
					),
					'group'       => __( 'Form Fields', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} button, {{WRAPPER}} .btn, {{WRAPPER}} input[type="button"], {{WRAPPER}} input[type="submit"]' => 'border-top-left-radius: {{TOP}};border-top-right-radius: {{RIGHT}};border-bottom-right-radius: {{BOTTOM}};border-bottom-left-radius: {{LEFT}};',
					),
					'group'      => __( 'Buttons', 'porto-functionality' ),
				),
				array(
