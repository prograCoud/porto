...
function porto_load_cursor_effect_shortcode() {
	...
	vc_map(
		array(
			...
			'icon'        => PORTO_WIDGET_URL . 'cursor-effect.gif',
			'class'       => 'porto-wpb-widget',
			'params'      => array(
				array(
					'type'        => 'checkbox',
					'heading'     => __( 'Spotlight Effect', 'porto' ),
					'description' => __( 'You can input under the 5 shapes.', 'porto-functionality' ),
					'param_name'  => 'cursor_shape',
					'hint'        => '<img src="' . PORTO_HINT_URL . 'cursor_effect_shape.gif"/>',
				),
				array(
					'type'        => 'textfield',
				...
				array(
					...
					'hint'        => '<img src="' . PORTO_HINT_URL . 'cursor_effect-hover_effect.gif"/>',
					'std'        => 'plus',
					'value'      => array(
				...
				array(
					'type'        => 'textfield',
					'heading'     => __( 'Cursor Shape Sizes(px)', 'porto-functionality' ),
					'param_name'  => 'shapes_size',
					'description' => __( 'Please input the size of shapes. Separate sizes by "," - For example: 10, 20, 30', 'porto-functionality' ),
					'std'         => '10,30,50',
					'dependency'  => array(
						'element'   => 'cursor_shape',
						'not_empty' => true,
				...
				array(
					'type'        => 'textfield',
					'heading'     => __( 'Cursor Shape Color', 'porto-functionality' ),
					'param_name'  => 'shapes_color',
					'description' => __( 'Please input the color of shapes. Separate colors by "," - For example: #5AE2FF, #3CC4FF, #1EA6EA. The Number of colors should be the same as number of the sizes.', 'porto-functionality' ),
					'std'         => '#5AE2FF, #3CC4FF, #1EA6EA',
					'dependency'  => array(
						'element'   => 'cursor_shape',
						'not_empty' => true,
					),
